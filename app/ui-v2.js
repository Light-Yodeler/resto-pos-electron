...
const UI_COPY = {
  ...
  en: {
    ...
    printer: '80 mm receipt printer', printerHint: 'Thermal printer settings for Windows and macOS.', directEngine: 'Direct-print mode', nativeEscpos: 'Native ESC/POS text · Recommended', windowsGraphics: 'Windows graphics · Compatibility', nativeWidth: 'Native text width', safe42: '42 characters · Safe', wide48: '48 characters · 576-dot printer', graphicsWidth: 'Graphics content area', safe64: '64 mm · Safe', medium68: '68 mm · Medium', full72: '72 mm · Full width', receiptFont: 'Receipt font style', clearFont: 'Thin and clear · Monospace', mediumFont: 'Medium · Sans serif', boldFont: 'Bold · Sans serif', distinctFont: 'High legibility digits · Segoe / Trebuchet (Distinct 6, 8, 9)', sansCleanFont: 'Clean open sans · Tahoma / Verdana (Distinct)', defaultPrinter: 'Default printer', chooseDialog: 'Choose from the print dialog each time', cutDistance: 'Feed before cutting', shortFeed: '6 lines · Short', safeFeed: '8 lines · Safe', extraFeed: '10 lines · Extra safe', detectPrinter: 'Detect printers', testReceipt: 'Print test receipt', silentPrint: 'Print directly without dialog', autoCut: 'Cut paper automatically', printerNote: 'Use ESC/POS for the sharpest text. Select Windows graphics only when the printer does not support ESC/POS.',
